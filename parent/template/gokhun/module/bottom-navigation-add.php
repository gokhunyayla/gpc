					...
					<div class="row">
						<div class="col-12">
                            ...
                            ?>
                                ...
                                <?php $formname="bottom-navigation"; ?>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
															...
															<select class="form-control" name="source[<?php print $value0["code"]; ?>][<?php print $keyn; ?>][category]">
																...
																?>
																	...
																	<option value="<?php print $value1["category"]?>"><i class="<?php print $value1["class"]; ?>"></i> <?php print $value1["link-mask"]; ?></option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="source[<?php print $value0["code"]; ?>][<?php print $keyn; ?>][link-mask]" placeholder="<?php print $data["word"]["link-mask"]; ?>" value="">
                                                        </div>
