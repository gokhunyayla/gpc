                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea row="5" class="form-control" name="source[<?php print $value0["code"]; ?>][<?php print $keyn; ?>][comment]" placeholder="<?php print $data["word"]["comment"]; ?>"></textarea>
                                                        </div>
