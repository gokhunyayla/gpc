...
?>
	...
	?>
		...
		<img src="https://via.placeholder.com/300x200" class="card-img-top" alt="<?php print $image["content"]["body"]["text"]["title"]; ?>" title="<?php print $image["content"]["body"]["text"]["title"]; ?>">
