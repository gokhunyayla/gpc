...
?>
	...
	?>
		...
		<img src="https://via.placeholder.com/900x500" class="card-img-top" alt="<?php print $image["content"]["body"]["text"]["title"]; ?>" title="<?php print $image["content"]["body"]["text"]["title"]; ?>">
