                        ...
                        <div class="blog-d-box">
                            ...
                            ?>
                                ...
                                <div class="image-box">
                                    <?php
                                    $image=$data["page"];
                                    include($data["config"]["path"]["module"]."/look-image.php")
                                    ?>
                                </div>
                            ...
                            <div class="image-content">
                                ...
                                ?>
                                    ...
                                    <?php
                                    include($data["config"]["path"]["module"]."/catalog-carousel.php");
                                    ?>
                                ...
                                <p><a class="btn btn-primary" style="margin:10px 0px; padding:10px;" target="_blank" href="<?php print $data["word"]["all-page-link"]; ?>"><?php print $data["word"]["all-page-link-mask"]; ?></a></p>
                            </div>
