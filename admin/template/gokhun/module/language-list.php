							...
							<div class="card">
								...
								<div class="card-header">
									<div class="row">
										...
										<div class="col-4 text-right"><a href="<?php print $database->afv("language-add"); ?>" class="btn btn-primary"><?php print $data["word"]["add-new"]; ?></a></div>
									</div>
								</div>
										...
										<table id="table_id" class="display">
											<thead>
												<tr>
													...
													<th><?php print $data["word"]["code"]; ?></th>
													<th></th>
											...
											<tbody>
												...
												?>
													...
													$medium["variable"]=$key;
													$medium["key"]=$key0;
													$medium["code"]=$value0["code"];
													?>

													<tr>
														<td><?php print $value0["name"]; ?></td>
														<td><?php print $value0["code"]; ?></td>
														<td>
															...
															<form id="delete-<?php print $key0; ?>" method="post" action="<?php print $database->afv("language-key-delete"); ?>"><input type="hidden" name="medium" value="<?php print base64_encode(json_encode($medium, JSON_UNESCAPED_UNICODE)); ?>"><div id="delete-<?php print $key0; ?>-result"></div></div></form>
