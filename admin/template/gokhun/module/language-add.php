					...
					<div class="row">
						<div class="col-12">
                            ...
                            ?>
                                ...
                                <?php $formname="language"; ?>
                                <form id="<?php print $formname; ?>" method="post" action="<?php print $database->afv("language-add-check"); ?>">
                                            ...
                                            <div id="<?php print $value0["code"]; ?>" class="tab-pane <?php if ($key0==0){ ?>fade show active<?php } ?> pt-3 pb-3 pl-1" role="tabpanel" aria-labelledby="tab-<?php print $value0["code"]; ?>">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label><?php print $data["word"]["code"]; ?></label>
                                                            <input type="text" class="form-control" name="source[<?php print $value0["code"]; ?>][<?php print $keyn; ?>][code]" placeholder="<?php print $data["word"]["code"]; ?>" value="">
                                                        </div>
