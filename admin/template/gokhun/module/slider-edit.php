						...
						<div class="col-12">
							...
							?>
								...
								?>
									...
									<?php $formname="slider"; ?>
									<form id="<?php print $formname; ?>" method="post" action="<?php print $database->afv("slider-edit-check"); ?>">
																		...
																		?>
																			...
																			<div class="form-group">
																				<div class="file btn btn-primary">
																					<?php print $data["word"][$key2]; ?> <?php print $data["word"]["upload"]; ?>
																					<input type="file" name="source[<?php print $value0["code"]; ?>][<?php print $key1; ?>][<?php print $key2; ?>]" placeholder="<?php print $data["word"][$key2]; ?>" />
																				</div>
																			</div>
															
																			<?php
																			$filevar="media/".$value0["code"]."/".$value2;
																			?>
																			...
																			?>
																				...
																				<a href="#" data-toggle="modal" data-target="#<?php print $value0["code"]; ?>-<?php print $key1; ?>" title="<?php print $value2; ?>"><img height="150px" src="<?php print $filevar; ?>" alt="<?php print $value2; ?>" title="<?php print $value2; ?>"></a>

																				<div class="modal fade" id="<?php print $value0["code"]; ?>-<?php print $key1; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php print $value0["code"]; ?>-<?php print $key1; ?>" aria-hidden="true">
																				  <div class="modal-dialog" role="document">
																					<div class="modal-content">
																					  <div class="modal-header">
																						<h5 class="modal-title"><?php print $value0["code"]; ?>-<?php print $key0; ?>: <?php print $value2; ?></h5>
																						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																						  <span aria-hidden="true">&times;</span>
																						</button>
																					  </div>
																					  <div class="modal-body">
																						<img class="img-fluid" src="<?php print $filevar; ?>" alt="<?php print $value2; ?>" title="<?php print $value2; ?>">
																					  </div>
