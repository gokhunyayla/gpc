						...
						<div class="col-12">
							...
							<div class="card">
								...
								<div class="card-body p-3">
									...
									<?php
									$key="contact";
									$var0=$site["database"]->cs($site["database"]->prefix."status<>'removed'");
									?>
										...
										<table id="table_id" class="display">
											<thead>
												<tr>
													...
													<th><?php print $data["word"]["phone"]; ?></th>
													<th></th>
											...
											<tbody>
												...
												?>
													...
													foreach ($data["status"]["form"] as $key1=>$value1)
													{
													?>
													...
													<tr>
														<td><div class="btn btn-<?php if ($value0["status"]=="completed"){ ?>success<?php }elseif ($value0["status"]=="appointed"){ ?>warning<?php }else{ ?>danger<?php } ?>"><?php print $status; ?></div></td>
														<td><?php print $value0["content"]["name"]; ?></td>
														<td><?php print $value0["content"]["phone"]; ?></td>
														<td class="text-right">
