...
?>
    ...
    ?>
		...
		<?php
        $site["database"]->ad($site["database"]->prefix."option", $site["database"]->prefix.$medium["code"]);
        $site["database"]->ad($site["database"]->prefix."link", $site["database"]->prefix."link_".$medium["code"]);
        $site["database"]->ad($site["database"]->prefix."link", $site["database"]->prefix."content_".$medium["code"]);
        $site["database"]->ad($site["database"]->prefix."link", $site["database"]->prefix."comment_".$medium["code"]);
        $site["database"]->ad($site["database"]->prefix."link", $site["database"]->prefix."count_".$medium["code"]);
        ?>

		<?php
		$site["database"]->cd($site["database"]->prefix."language='".$medium["code"]."'")
		?>
